...
| 29 | **Section Layout** (§31): naya menu, list, Add New; page pe har block apna card, FAQ accordion, na stat rail na hero/WhatsApp button | Tests + render se verify; page client banayega |
