...
| **Enquiries ▸ Bulk actions** me `Mark New` nahi | Client ne hatwaya (23 Sep) — enquiry ko wapas "new" karne ka koi kaam nahi. Sirf bulk dropdown se: `New` tab, status aur Detail screen ka Status dropdown waise hi hain |
...
- **Band/khule panel (18 Sep, client):** Layout ke chhe panel, Fonts ke Heading Font · Body Font · Text Sizes, aur Colours ka
  Site Colours — `components/admin/Panel.jsx` (head pe click, ▾/▸). **Preview kabhi band nahi** — Save usi me hai.
  Colours ka Advanced pehle se band/khula tha (reference v4 ki apni shakal) — waisa hi.
- **Layout:** Page Width (slider 1200–1600 + side space desktop/mobile) · **Spacing** (D-100, 18 Sep — Section spacing
